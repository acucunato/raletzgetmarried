  ...
  return (
    <>
      <div className="photo-gallery">
        <div className="row">
          <Nav />
          <div className="col-md-3 p-1 pt-4 text-center wow fadeIn ">
        ...
        <div className="row justify-content-center">
          <div className="col-md-3 p-1 text-center wow fadeIn ">
            <img
        ...
        <div className="row justify-content-center">
          <div className="col-md-6 p-1 text-center wow fadeIn ">
            <img
        ...
        <div className="row justify-content-center">
          <div className="col-md-2 p-1 text-center wow fadeIn ">
            <img
              src="
          ...
          <div className="col-md-5 p-1 text-center wow fadeIn ">
            <img
